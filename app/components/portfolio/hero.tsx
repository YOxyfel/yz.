    ...
    >
      ...
      <div className="station-section-inner">
        <motion.div
          ...
          transition={reducedMotion ? { duration: 0 } : { duration: 0.8, ease: [0.21, 0.47, 0.32, 0.98] }}
          className="hero-bridge relative z-[1]"
        >
          <motion.span
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={
              reducedMotion ? { duration: 0 } : { duration: 0.75, delay: 0.08, ease: [0.21, 0.47, 0.32, 0.98] }
            }
            className="mx-auto max-w-3xl text-balance font-heading text-3xl font-bold tracking-tight sm:text-5xl md:text-[3.25rem] md:leading-[1.08]"
          >
            {t('headline')}
          </motion.h1>
