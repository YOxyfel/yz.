...
export function CompareSwipe({
  ...
  return (
    ...
    >
      ...
      <div
        className="compare-swipe-handle absolute top-1/2 z-20 flex h-10 w-10 cursor-ew-resize items-center justify-center rounded-full border border-cyan/50 bg-black/70 text-cyan shadow-[0_0_24px_-4px_var(--cyan)] backdrop-blur-md"
        aria-hidden
      >
